...
public class OverworldEasyItemPool extends ItemPool {
    public OverworldEasyItemPool() {
        ...
        Items = new ArrayList<>(List.of(
                ...
                new ItemGroup(new String[]{"minecraft:barrel"}),
                new ItemGroup(new String[]{"minecraft:dispenser"}),
                new ItemGroup(new String[]{"minecraft:fletching_table"}),
                ...
                new ItemGroup(new String[]{"minecraft:cracked_deepslate_bricks"}),
                new ItemGroup(new String[]{"minecraft:smooth_stone"}),
                ...
                new ItemGroup(new String[]{"minecraft:glass"}),
                new ItemGroup(new String[]{
                        "minecraft:rabbit",
                ...
                new ItemGroup(new String[]{"minecraft:stone_hoe"}),
                ...
                new ItemGroup(new String[]{"minecraft:clay_ball"}),
                ...
                new ItemGroup(new String[]{"minecraft:dirt"}),
                new ItemGroup(new String[]{"minecraft:fishing_rod"}),
                new ItemGroup(new String[]{"minecraft:flint"}),
                new ItemGroup(new String[]{
                        "minecraft:peony",
                ...
                new ItemGroup(new String[]{"minecraft:feather"}),
                new ItemGroup(new String[]{"minecraft:smoker"}),
                new ItemGroup(new String[]{"minecraft:rail"}),
                new ItemGroup(new String[]{"minecraft:gravel"}),
                new ItemGroup(new String[]{"minecraft:tinted_glass"}),
                new ItemGroup(new String[]{"minecraft:bow"}),
                new ItemGroup(new String[]{"minecraft:bowl"}),
                ...
                new ItemGroup(new String[]{"minecraft:wooden_hoe"}),
                ...
                new ItemGroup(new String[]{"minecraft:gunpowder"}),
                new ItemGroup(new String[]{
                        "minecraft:beetroot",
