...
public class OverworldHardItemPool extends ItemPool {
    public OverworldHardItemPool() {
        ...
        Items = new ArrayList<>(List.of(
                new ItemGroup(new String[]{"minecraft:respawn_anchor"}),
                ...
                new ItemGroup(new String[]{"minecraft:enchanting_table"}),
                new ItemGroup(new String[]{"minecraft:tnt"}),
                new ItemGroup(new String[]{"minecraft:pumpkin_pie"}),
                new ItemGroup(new String[]{"minecraft:lodestone"}),
                new ItemGroup(new String[]{"minecraft:cookie"}),
                new ItemGroup(new String[]{"minecraft:end_crystal"}),
                new ItemGroup(new String[]{"minecraft:target"}),
                new ItemGroup(new String[]{"minecraft:carrot_on_a_stick"}),
                new ItemGroup(new String[]{"minecraft:enchanted_book"}),
                new ItemGroup(new String[]{"minecraft:enchanted_golden_apple"}),
                new ItemGroup(new String[]{
                        "minecraft:pearlescent_froglight",
                        "minecraft:verdant_froglight",
                        "minecraft:ochre_froglight"
                }),
                new ItemGroup(new String[]{"minecraft:cocoa_beans"}),
                new ItemGroup(new String[]{"minecraft:minecart"}),
                new ItemGroup(new String[]{"minecraft:glistering_melon_slice"}),
                ...
                new ItemGroup(new String[]{"minecraft:tinted_glass"}),
                ...
                new ItemGroup(new String[]{"minecraft:experience_bottle"}),
                ...
                new ItemGroup(new String[]{"minecraft:netherrack"}),
                new ItemGroup(new String[]{
                        "minecraft:piston",
                ...
                new ItemGroup(new String[]{"minecraft:cobweb"}),
                new ItemGroup(new String[]{
                ...
                new ItemGroup(new String[]{"minecraft:chiseled_quartz_block"}),
                ...
                new ItemGroup(new String[]{"minecraft:totem_of_undying"}),
                new ItemGroup(new String[]{
                ...
                new ItemGroup(new String[]{"minecraft:brewing_stand"}),
                new ItemGroup(new String[]{
                ...
                new ItemGroup(new String[]{"minecraft:ender_eye"}),
                ...
                new ItemGroup(new String[]{"minecraft:poisonous_potato"}),
                new ItemGroup(new String[]{
                ...
                new ItemGroup(new String[]{"minecraft:iron_door"}),
                new ItemGroup(new String[]{"minecraft:iron_trapdoor"}),
                new ItemGroup(new String[]{"minecraft:tripwire_hook"}),
                new ItemGroup(new String[]{"minecraft:suspicious_stew"}),
                new ItemGroup(new String[]{
                        "minecraft:cracked_stone_bricks",
                        "minecraft:chiseled_stone_bricks"
                }),
                new ItemGroup(new String[]{"minecraft:stonecutter"}),
                new ItemGroup(new String[]{
                ...
                new ItemGroup(new String[]{"minecraft:turtle_helmet"}),
                ...
                new ItemGroup(new String[]{"minecraft:fishing_rod"}),
                new ItemGroup(new String[]{"minecraft:cauldron"}),
                new ItemGroup(new String[]{"minecraft:cactus"}),
                new ItemGroup(new String[]{"minecraft:raw_copper_block"}),
                new ItemGroup(new String[]{
                ...
                new ItemGroup(new String[]{"minecraft:redstone_torch"}),
                new ItemGroup(new String[]{"minecraft:iron_bars"}),
                new ItemGroup(new String[]{"minecraft:spyglass"}),
                new ItemGroup(new String[]{
                        "minecraft:potato",
                ...
                new ItemGroup(new String[]{"minecraft:sea_pickle"}),
                ...
                new ItemGroup(new String[]{"minecraft:smithing_table"}),
                new ItemGroup(new String[]{
                ...
                new ItemGroup(new String[]{"minecraft:red_mushroom"}),
                new ItemGroup(new String[]{
