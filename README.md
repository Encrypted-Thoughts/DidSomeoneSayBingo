...
## Installation
The below steps assume you have already setup a fabric 1.20.2 server. See [fabricmc.net/use/installer](https://fabricmc.net/use/installer) to download the fabric installer and for installation instructions.
